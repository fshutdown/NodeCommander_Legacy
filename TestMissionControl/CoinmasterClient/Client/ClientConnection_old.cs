...
{
    public class ClientConnection_old
    {
        ...
        private Action<ClientConnection_old> _onConnected;
        private Action<string, ClientConnection_old> _onMessage;
        private Action<ClientConnection_old> _onDisconnected;
        ...
        public static ClientConnection_old Create(string address, string port)
        {
            return new ClientConnection_old(address, port);
        }

        protected ClientConnection_old(string host, string port)
        {
            Host = host;
            Port = port;
        ...
        /// </summary>
        /// <returns></returns>
        public ClientConnection_old Connect()
        {
        ...
        /// <returns></returns>
        public ClientConnection_old OnConnect(Action<ClientConnection_old> onConnect)
        {
        ...
        /// <returns></returns>
        public ClientConnection_old OnDisconnect(Action<ClientConnection_old> onDisconnect)
        {
        ...
        /// <returns></returns>
        public ClientConnection_old OnMessage(Action<string, ClientConnection_old> onMessage)
        {
